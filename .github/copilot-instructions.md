...
## Project Overview
This is a static website for the fictional nation of Waikiki, generated by Copilot. The site combines HTML/CSS public pages with canonical Markdown content sources under `content/` that serve as the authoritative narrative foundation.
...
- **Developer Navigation**: `README.md` provides an english summary with the most important facts and foundations for Waikiki

## Narrative Foundation

### State Overview
- **Waikiki**: Fictional democratic dictatorship, world's wealthiest nation
...
- **2012**: Summer Olympics hosted in Nova Aurelia; Hercegi Palota construction underway
...
### Language & Typography
- **Primary Language**: English with official tone
- **Images and icons**: Public URLs with relevant images, graphics or icons
- **Continuous text**: Use formal, natural continuous text, avoid lists if possible
- **Avoid special characters**: Avoid using ':', ';', '(' and ')' characters if possible
- **Use correct hyphen**: Always prefer '-' over '‑'
...
- **Concise Format**: Bullet points for timelines, structured sections for longer content, continuous text when possible
...
- **Population**: 212M (2021), growing 500k/year, distributed across 3 provinces
...
- **Social**: Free healthcare (2017-), free transport (2018-), cashless economy (2018-)
...
- **Communication style**: The `content/Communication.md` outlines basic principles for the official communication of the Waikiki government that should be followed
